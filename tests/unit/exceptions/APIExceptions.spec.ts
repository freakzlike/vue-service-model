...
describe('exceptions/APIExceptions', () => {
  ...
  describe('APIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Unhandled APIException')
  ...
  describe('BadRequestAPIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Bad Request')
      expect(error.response).toBe(response)
    })
  })
  ...
  describe('UnauthorizedAPIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Unauthorized')
      expect(error.response).toBe(response)
    })
  })
  ...
  describe('ForbiddenAPIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Forbidden')
      expect(error.response).toBe(response)
    })
  })
  ...
  describe('NotFoundAPIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Not Found')
      expect(error.response).toBe(response)
    })
  })
  ...
  describe('InternalServerErrorAPIException', () => {
    it('should return correct instance', async () => {
      ...
      expect(error.message).toBe('[vue-service-model] Internal Server Error')
      expect(error.response).toBe(response)
    })
  })
})
